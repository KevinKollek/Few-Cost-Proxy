...
class ConfigFileParser():
    ...
    def __init__(self, config_options=[], verbose=False):
        ...
        self.add_option(ConfigOption('proxy_names', type=list, default=['val_acc'], required=False))
        self.add_option(ConfigOption('device', type=list, default='cpu', required=False))
