...
class ImageAugmentation(PipelineNode):
    ...
    def fit(self, pipeline_config, hyperparameter_config, dataset_info, X, Y, train_indices, valid_indices):
        mean, std = [0.4915013313293457, 0.4822464883327484, 0.44654974341392517], [0.2024516463279724, 0.19960476458072662, 0.20110046863555908]#self.compute_mean_std(pipeline_config, hyperparameter_config, X, Y, train_indices, dataset_info) #dataset_info.mean, dataset_info.std
        ...
        # [0.4915013313293457, 0.4822464883327484, 0.44654974341392517]
        # [0.2024516463279724, 0.19960476458072662, 0.20110046863555908]
